...
<div class="box span12">
	...
	<div class="box-content">
	 <form action="/update_product" method="POST" enctype="multipart/form-data" class="mr-4">
                    @csrf
...
<div>
		...
		<!-- 	<div class="control-group hidden-phone">
			  ...
			  <div class="controls">
				<textarea class="cleditor" name="product_short_description" rows="3"value="">{{$data->product_short_description}}</textarea>
			  </div>
			</div>
			<div class="control-group hidden-phone">
			  ...
			  <div class="controls">
				<input type="text" class="input-xlarge " name="product_price" value="{{$data->product_price}}">
                 ...
                 <!--   <div class="form-group">
                    ...
                    <input type="file" name="product_image" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"value="{{$data->product_image}}">
                     </div>
                       <div class="control-group">
