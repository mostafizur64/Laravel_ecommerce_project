                ...
                <div class="row">
                    <div class="col-sm-4">
                      <div class="logo pull-left">
                            <a href='/'><img src="fontend/images/home/logo.png" alt="" /></a>
                        </div>
                    ...
                    <div class="col-sm-8">
                        ...
                        <?php }else{?>
                            ...
                            <?php } ?>
                                  ...
                                  <li><a href="/product_cartList"><i class="fa fa-shopping-cart"></i> 
                                Cart({{$total}})</a></li>
                        ...
                        <?php }else{?>
                            ...
                            <?php } ?>
                              <!-- <?php $customer_id=Session::get('user');?>
                            @if($customer_id != NULL)
                            {
                            ...
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        ...
                                        <li><a href="/loginpage">Checkout</a></li> 
                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                            ...
                            <?php
                              ...
                              <div class="panel panel-default">
                                  <div class="panel-heading">
                                     <!--  <li><a href="#"> <span></span>{{$value->category_name}}</a></li> -->
                         <h4 class="panel-tittle"><a href="{{'/show_by_category_product/'.$value->id}}">{{$value->category_name}}</a></h4>
                                  </div>
                              </div>
                        ...
                        <div class="brands_products"><!--brands_products-->
                           ...
                           <?php
                               $all_manufacture=DB::table('manufacturs')
                               ->where('publication_status',1)
                               ->get();
                               foreach($all_manufacture as $value){?>
                                    <li><a href="{{'/show_by_manufacture_product/'.$value->id}}"> <span class="pull-right">(50)</span>{{$value->manufacture_name}}</a></li>
